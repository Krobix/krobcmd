...
virtual std::string inOp(); //Controls what happens when input is given to the object
virtual std::string outOp(); //Controls what happens when the contents are requested
